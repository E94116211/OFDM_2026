...
\begin{frame}
    ...
    \begin{align*}
        ...
        &=\left(\sum_{n=0}^{N-1}a_n e^{-j2\pi f\tau_n}\right)\left(\sum_{m=0}^{N-1}a_m^*e^{j2\pi f\tau_m}\right)\\[2mm]
        &=\sum_{n=0}^{N-1}\sum_{m=0}^{N-1}a_n a_me^{-j2\pi f(\tau_n-\tau_m)}, \qquad a_m\in\mathbb{R}
    \end{align*}
...
\begin{frame}
    ...
    \begin{align*}
        &\sum_{n\neq m}a_n a_me^{-j2\pi f(\tau_n-\tau_m)}\\[2mm]&
        =\Big[a_0a_1e^{-j2\pi f(\tau_0-\tau_1)}+a_1a_0e^{-j2\pi f(\tau_1-\tau_0)}\Big]
        \\[1mm]&\quad+\Big[a_0a_2e^{-j2\pi f(\tau_0-\tau_2)}+a_2a_0e^{-j2\pi f(\tau_2-\tau_0)}
        \Big]\\[1mm]&\quad
...
\begin{frame}
    ...
    \begin{align*}
    &=\Big[a_0a_1\left(e^{-j2\pi f(\tau_0-\tau_1)}+e^{j2\pi f(\tau_0-\tau_1)}\right)\Big]\\[2mm]
    &\quad+\Big[a_0a_2\left(e^{-j2\pi f(\tau_0-\tau_2)}+e^{j2\pi f(\tau_0-\tau_2)}\right)\Big]\\&\quad+\cdots\\[2mm]
    &\quad+\Big[a_{N-2}a_{N-1}\left(e^{-j2\pi f(\tau_{N-2}-\tau_{N-1})}+e^{j2\pi f(\tau_{N-2}-\tau_{N-1})}\right)\Big]\\[4mm]
    &=2a_0a_1\cos\left[2\pi f(\tau_0-\tau_1)\right]\\&\quad+2a_0a_2\cos\left[2\pi f(\tau_0-\tau_2)\right]+\cdots
    \\&\quad+2a_{N-2}a_{N-1}\cos\left[2\pi f(\tau_{N-2}-\tau_{N-1})\right]\\[4mm]
    \end{align*}
...
\begin{frame}
    ...
    \begin{align*}
       &=2\sum_{n=0}^{N-2}\sum_{m=n+1}^{N-1}a_na_m\cos\left[2\pi f(\tau_n-\tau_m)\right].
    \end{align*}
...
Therefore, for all $n\neq m$,
    ...
    \begin{align*}
        &\sum_{n\neq m}a_n a_me^{-j2\pi f(\tau_n-\tau_m)}\\[2mm]
        &=2\sum_{n=0}^{N-2}\sum_{m=n+1}^{N-1}a_n a_m\cos\left[2\pi f(\tau_n-\tau_m)\right].
    \end{align*}
...
\end{itemize}
    ...
    \begin{align*}
        |H(f)|^2
        &=\sum_{n=0}^{N-1} a_n^2+2\sum_{n=0}^{N-2}
        \sum_{m=n+1}^{N-1}a_n a_m\cos\left[2\pi f(\tau_n-\tau_m)\right].
    \end{align*}
...
%----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multipath propagation (6666666666/13)}
    \begin{itemize}
...
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Appendix: Carrier Frequency Offset (CFO) Results in Inter-Carrier Interference (ICI) (1/5)}
    \begin{itemize}
...
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Appendix: Carrier Frequency Offset (CFO) Results in Inter-Carrier Interference (ICI) (2/5)}
    \begin{itemize}
...
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Appendix: Carrier Frequency Offset (CFO) Results in Inter-Carrier Interference (ICI) (3/5)}
    \begin{itemize}
...
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Appendix: Carrier Frequency Offset (CFO) Results in Inter-Carrier Interference (ICI) (4/5)}
    \begin{figure}
      \centering
...
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Appendix: Carrier Frequency Offset (CFO) Results in Inter-Carrier Interference (ICI) (5/5)}
    \begin{itemize}
...
\begin{itemize}
  \item When $m\not= k$, 
  \begin{align*}
    &\alpha_{m\rightarrow k}=\frac{e^{j\pi f_{m}(0.8)}}{N}\frac{1-e^{\pm j2\pi (0.2)}}{1-e^{\pm j2\pi \frac{1}{N}}}\not= 0\ \ \text{(ISI, ICI)}&\\
    &\beta_{m\rightarrow k}=\frac{e^{-j2\pi f_{m}(0.2)}}{N}\frac{e^{\pm j2\pi (0.4)}\pm 1}{1-e^{\pm j2\pi \frac{1}{N}}}\not= 0\ \ \text{(ICI)}&
  \end{align*}
\end{itemize}
\end{frame}
%-----------------------------------------------------------------------------%
