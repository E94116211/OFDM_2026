...
\begin{frame}
    ...
    \begin{align*}
    &=2\sum_{n=0}^{N-2}\sum_{\substack{m=n+1\\n<m}}^{N-1}\operatorname{Re}\left\{a_n a_m^{*}e^{-j2\pi f(\tau_n-\tau_m)}\right\}\\[6pt]
    &=2\sum_{n=0}^{N-2}\sum_{\substack{m=n+1\\n<m}}^{N-1}\operatorname{Re}\left\{|a_n|e^{j\phi_n}|a_m|e^{-j\phi_m}e^{-j2\pi f(\tau_n-\tau_m)}\right\}\\[6pt]
    &=2\sum_{n=0}^{N-2}\sum_{\substack{m=n+1\\n<m}}^{N-1}|a_n||a_m|\operatorname{Re}\left\{e^{j\left[\phi_n-\phi_m-2\pi f(\tau_n-\tau_m)\right]}\right\}\\[6pt]
    \end{align*}
