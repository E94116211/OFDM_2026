...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \\{\scriptsize
    \[x(t)=\begin{cases}
    X_{1,\text{prev}}e^{j2\pi f_{1}(t+0.1)}\ +\ X_{2,\text{prev}}e^{j2\pi f_{2}(t+0.1)},&-0.1\le t<0\\
    ...
    \\{\scriptsize
    \[x[n]=\begin{cases}
    X_{1,\text{prev}}e^{j2\pi f_{1}(nT_{s}+0.1)}\ +\ X_{2,\text{prev}}e^{j2\pi f_{2}(nT_{s}+0.1)},&-0.2N\le n<0\\
...
\begin{itemize}
  ...
  \begin{flalign*}
    &Y[k]&
    \\=&\frac{1}{N}\sum_{n=-0.2N}^{-1}\sum_{m=1}^{2}(X_{m,\text{prev}}e^{j2\pi f_{m}0.1 e^{j2\pi \frac{m}{N}n}})e^{-j2\pi \frac{k}{N}n}&
...
\begin{itemize}
    ...
    \[\begin{cases}
    Y[1]=0.8X_{1,\text{curr}}+\beta_{2\rightarrow 1}X_{2,\text{curr}}+\alpha_{2\rightarrow 1}X_{2,\text{prev}}\\
    Y[2]=0.8X_{2,\text{curr}}+\beta_{1\rightarrow 2}X_{1,\text{curr}}+\alpha_{1\rightarrow 2}X_{1,\text{prev}}
    \end{cases}\]
