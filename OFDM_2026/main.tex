...
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (1/11)}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{time_synchronization_error_ICI.eps}
    \end{figure}
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (2/11)}
    \begin{figure}
        \centering
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (3/11)}
\begin{itemize}
  \item \textbf{Proof:}
...
T_s &= \frac{0.5}{N}\ \mathrm{s},\\
f_1 &= 2\ \mathrm{Hz},\quad f_2 = 4\ \mathrm{Hz}.
\end{aligned}
\]
\end{block}
\end{columns}
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (4/11)}
\begin{itemize}
...
\vspace{-4pt}
\begin{itemize}
  \item Because the FFT window contains two OFDM symbols,
  \vspace{-2pt}
  \[
  Y[k]
  =
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (5/11)}
\begin{itemize}
...
\begin{itemize}
  ...
  e^{j2\pi(m-k)n/N}.
  \]
  \item Let $r_{m,k} \triangleq e^{j2\pi(m-k)/N}$. Then,
  \[
  \boxed{
  \alpha_{m\rightarrow k}
  =
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (6/11)}
\begin{itemize}
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (7/11)}
\begin{itemize}
...
\small
The desired subcarrier is attenuated to $80\%$ of its original amplitude and experiences a phase rotation. The previous OFDM symbol contributes ISI to the same FFT bin.
\end{block}
\end{frame}
%-----------------------------------------------------------------------------%
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (8/11)}
\begin{itemize}
  \item \textbf{Case 2: $m\neq k$}
  \item For the previous OFDM symbol,
  \[
...
\begin{block}{Interpretation}
\small
The previous OFDM symbol leaks into the current FFT window. Therefore, it produces interference at the considered FFT bin $k$.
\end{block}
\end{frame}
%-----------------------------------------------------------------------------%
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (9/11)}
\begin{itemize}
...
\begin{block}{Interpretation}
\small
The other current subcarriers generate inter-carrier interference through $\beta_{m\rightarrow k}$.
\end{block}
\end{frame}
%-----------------------------------------------------------------------------%
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (10/11)}
\begin{itemize}
...
\vspace{-4pt}
\begin{itemize}
  \item Therefore, timing synchronization error causes
  \begin{itemize}
    \item amplitude attenuation and phase rotation of the desired signal;
    \item ICI from other current subcarriers;
    \item ISI and additional interference from the previous OFDM symbol.
  \end{itemize}
\end{itemize}
\end{frame}
%-----------------------------------------------------------------------------%
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (11/11)}
\begin{block}{Without timing synchronization error}
\[
\boxed{
Y[k]=X_{k,\mathrm{curr}}
}
\]
\end{block}
\vspace{-4pt}
...
\small
Without timing synchronization error, the FFT output contains only the desired current subcarrier symbol. ISI and ICI are absent.
\end{block}
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
