...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \end{cases}$
    \\ \item We see only the current symbol in the demodulation window of FFT.
  \end{itemize}
\end{itemize}
\end{frame}
%-----------------------------------------------------------------------------%
...
\begin{itemize}
  ...
  $Y[k]=\frac{1}{N}\sum_{n=0}^{0.8N-1}(X_{1}^{curr}e^{j2\pi \frac{1}{N}}\ +\ X_{2}^{curr}e^{j2\pi \frac{2}{N}})e^{-j2\pi \frac{k}{N}n}$
  \\$Y[k]=X_{1}^{curr}\cdot \beta_{m\rightarrow k}+X_{1}^{curr}\cdot \beta_{m\rightarrow k},\ m\in [1,2]$
  \item When $m=k$,
  \\$\beta_{k\rightarrow k}=\frac{1}{N}\sum_{n=0}^{0.8N-1}1=\frac{0.8N}{N}=0.8$
  \item When $m\not= k$, 
  \\$\beta_{1\rightarrow 2}=\frac{1}{N}\frac{1-e^{-j2\pi (0.8)}}{1-e^{-j2\pi \frac{1}{N}}}\not= 0$
  \\$\beta_{2\rightarrow 1}=\frac{1}{N}\frac{1-e^{j2\pi (0.8)}}{1-e^{j2\pi \frac{1}{N}}}\not= 0$
  \item $Y[1]=0.8X_{1}^{curr}+\beta_{2\rightarrow 1}X_{2}^{curr}$
