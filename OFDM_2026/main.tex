\documentclass[xcolor=dvipsnames,aspectratio=169]{beamer} % 使用beamer類，並允許使用dvipsnames顏色，16:9比例
...
\setbeamertemplate{headline}{
    ...
    \hbox{% 開始水平盒子
        ...
        \begin{beamercolorbox}[wd=.1\paperwidth,ht=2.25ex,dp=1ex,center]{title in head/foot}
            ...
            \raisebox{-1.1ex}{\includegraphics[keepaspectratio,width=1.2cm]{SpaceComm LOGO_Black_ Horizontal 1.png}}\hspace*{1ex}
        \end{beamercolorbox}%
    }%
...
\titlegraphic{\vspace{-2cm}\hspace{10cm}\includegraphics[width=2cm]{ncku_logo.jpg}
}
\date{\today}
\begin{document}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{SC_MC.eps}
    \end{figure}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{OFDM_signal.eps}
    \end{figure}
\end{frame}
%----------------------------------------------------------------------------%
\begin{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{transmitter.eps}
    \end{figure}
\end{frame}
%----------------------------------------------------------------------------%
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{MC_System.eps}
    \end{figure}
\end{frame}
%----------------------------------------------------------------------------%
\begin{frame}
...
\begin{frame}
    \frametitle{Transmitted Signal (3/4)}
        \centering
        \includegraphics[width=0.75\textwidth]{delta_f.eps}
\end{frame}
%----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Transmitted Signal (4/4)}
        \begin{figure}
        \centering
            \includegraphics[width=0.6\textwidth]{sc.eps}
        \end{figure}
\end{frame}
%----------------------------------------------------------------------------%
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.75\textwidth]{e04su3su;6.png}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.64\textwidth]{Delay_SymbolTime.eps}
    \end{figure}
\end{frame}
%----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multipath propagation (1/13)}
    \begin{itemize}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.69\textwidth]{Multipath_propagation.eps}
    \end{figure}
\end{frame}
%----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multipath propagation (2/13)}
    \begin{itemize}
        \item Multipath propagation results in a received signal that is dispersed in time.
    \end{itemize}
    \begin{figure}
        \centering
        \includegraphics[width=0.65\textwidth]{multipath_2.png}
...
\begin{frame}
    \frametitle{Multipath propagation (3/13) --- Proof}
    \begin{itemize}
...
%----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multipath propagation (4/13) --- Proof}
    ...
    \begin{itemize}
        ...
        \begin{align*}
            ...
            &= \sum_{n=0}^{N-1}
            a_n \delta(t-\tau_n) \\
            &\text{where } a_n \text{ is a random complex value of the }n\text{-th path,}\\
...
%----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multipath propagation (5/13) --- Proof}
    \small
    \begin{align*}
        &=
        \left(\sum_{n=0}^{N-1}a_n e^{-j2\pi f\tau_n}\right)\left[\sum_{m=0}^{N-1}a_m e^{-j2\pi f\tau_m}\right]^*\\[2mm]
        &=\left(\sum_{n=0}^{N-1}a_n e^{-j2\pi f\tau_n}\right)\left(\sum_{m=0}^{N-1}a_m^*e^{j2\pi f\tau_m}\right)\\[2mm]
        &=\sum_{n=0}^{N-1}\sum_{m=0}^{N-1}a_n a_m^*e^{-j2\pi f(\tau_n-\tau_m)}.
    \end{align*}
...
%----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multipath propagation(6/13) --- Proof}
...
\begin{align*}
    ...
    a_n a_m^* e^{-j2\pi f(\tau_n-\tau_m)}\\[2mm]
    &=\sum_{n=0}^{N-1} |a_n|^2.
\end{align*}
...
%----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multipath propagation(7/13) --- Proof}
    ...
    \begin{align*}
        &\sum_{n=0}^{N-1}\sum_{\substack{m=0\\m\neq n}}^{N-1}a_n a_m^*e^{-j2\pi f(\tau_n-\tau_m)}\\[2mm]&
        =\Big[a_0a_1^*e^{-j2\pi f(\tau_0-\tau_1)}+a_1a_0^*e^{-j2\pi f(\tau_1-\tau_0)}\Big]
        \\[1mm]&\quad+\Big[a_0a_2^*e^{-j2\pi f(\tau_0-\tau_2)}+a_2a_0^*e^{-j2\pi f(\tau_2-\tau_0)}
        \Big]\\[1mm]&\quad
        +\cdots\\[1mm]&\quad+\Big[a_{N-2}a_{N-1}^*e^{-j2\pi f(\tau_{N-2}-\tau_{N-1})}
        \\&\qquad\qquad+a_{N-1}a_{N-2}^*e^{-j2\pi f(\tau_{N-1}-\tau_{N-2})}\Big].
    \end{align*}
...
%----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multipath propagation(8/13) --- Proof}

    \begin{align*}
    &=2\sum_{n=0}^{N-1}\sum_{\substack{m=0\\n\neq m}}^{N-1}\operatorname{Re}\left\{a_n a_m^{*}e^{-j2\pi f(\tau_n-\tau_m)}\right\}\\[6pt]
    &\qquad\left(a_n=|a_n|e^{j\phi_n},\quad a_m=|a_m|e^{j\phi_m}\right)\\
    &=2\sum_{n=0}^{N-1}\sum_{\substack{m=0\\n\neq m}}^{N-1}\operatorname{Re}\left\{|a_n|e^{j\phi_n}|a_m|e^{-j\phi_m}e^{-j2\pi f(\tau_n-\tau_m)}\right\}\\[6pt]
    &=2\sum_{n=0}^{N-1}\sum_{\substack{m=0\\n\neq m}}^{N-1}|a_n||a_m|\operatorname{Re}\left\{e^{j\left[\phi_n-\phi_m-2\pi f(\tau_n-\tau_m)\right]}\right\}\\[6pt]
    \end{align*}
...
%----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multipath propagation(9/13) --- Proof}


    \begin{align*}
        &=2\sum_{n=0}^{N-2}\sum_{\substack{m=0\\n\neq m}}^{N-1}|a_n||a_m|\cos\left[2\pi f(\tau_n-\tau_m)-\phi_n+\phi_m\right]\\
    \end{align*}
Therefore, for all $n\neq m$,
...
%----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multipath propagation(10/13) --- Proof}

    

    
\begin{itemize}
        \item Merge Case 1 and Case 2:
\end{itemize}

    \begin{align*}
        |H(f)|^2
        &=\sum_{n=0}^{N-1} |a_n|^2+2\sum_{n=0}^{N-2}\sum_{\substack{m=n+1\\n<m}}^{N-1}|a_n||a_m|\cos\left[\phi_n-\phi_m-2\pi f(\tau_n-\tau_m)\right]
    \end{align*}

\end{frame}
%----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multipath propagation (11/13) --- Proof}
    \begin{itemize}
        \item $a = b$.
        \begin{align*}
...
%----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multipath propagation (12/13)}
    \begin{itemize}
        \item Two paths, each with a different amplitude.
    \end{itemize}
    \begin{figure}
        \centering
        \includegraphics[width=0.85\textwidth]{delayspread1.eps}
    \end{figure}
\end{frame}
%----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multipath propagation (13/13)}
    \begin{itemize}
        \item Two paths, each with an amplitude equal to 1.
    \end{itemize}
    \begin{figure}
        \centering
        \includegraphics[width=0.85\textwidth]{delayspread2.eps}
    \end{figure}
\end{frame}
%----------------------------------------------------------------------------%
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        %\hspace{-1cm}
        \includegraphics[width=0.5\textwidth, trim=0.5cm 0.5cm 0.5cm 0.5cm, clip]{transmitted_signal_v5.eps}
    \end{figure}
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.85\textwidth]{OFDM_TD.eps}
    \end{figure}  
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{OFDM_FD.eps}
    \end{figure} 
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{frequency_error_ICI.eps}
    \end{figure}  
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{time_synchronization_ISI.eps}
    \end{figure}
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{FDM.eps}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.45\textwidth]{FDM_final.eps}

    \end{figure}
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multi-carrier Equivalent Implementation by using IDFT (1/7)}
    \begin{itemize}
...
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multi-carrier Equivalent Implementation by using IDFT (2/7)}
    \begin{itemize}
        \item In general, each carrier can be expressed as:
        \begin{equation}
            S_{c}(t)=A_{c}(t)e^{j(2\pi f_{c}t+\phi_{c}(t))}=A_{c}(t)e^{j\phi_{c}(t)}e^{j2\pi f_{c}t}   
        \end{equation}
...
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multi-carrier Equivalent Implementation by using IDFT (3/7)}
    \begin{itemize}
...
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multi-carrier Equivalent Implementation by using IDFT (4/7)}
    \begin{itemize}
...
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multi-carrier Equivalent Implementation by using IDFT (5/7)}
    \begin{itemize}
        \item Put the bracket of eq.(13) next to the IDFT eq.(14):
    \end{itemize}
    \[
        S_{s}(k\Delta t)=\left(\frac{1}{N}\sum_{n=0}^{N-1}A_{n}e^{j\phi_{n}}\,
        e^{j2\pi nk\,\Delta f\Delta t}\right)e^{j2\pi f_{0}k\Delta t}\quad(13)
    \]
    \[
        f(k\Delta t)=\frac{1}{N}\sum_{n=0}^{N-1}F(n\Delta f)\,e^{j2\pi nk/N}\quad(14)
    \]
    \begin{itemize}
        \item The two sums are equal iff the exponential terms are equal:
    \end{itemize}
    \[
        e^{j2\pi nk\,\Delta f\Delta t}=e^{j2\pi nk/N}
        \;\rightarrow\;\Delta f\,\Delta t=\frac{1}{N}
        \;\rightarrow\;\boxed{\;\Delta f=\frac{1}{N\Delta t}\;}\quad(15)
    \]
   
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multi-carrier Equivalent Implementation by using IDFT (6/7)}
    \begin{itemize}
...
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multi-carrier Equivalent Implementation by using IDFT (7/7)}
        \centering
        \includegraphics[width=0.5\textwidth]{Multi_carrier_Equivalent_1.eps}
        \vspace{5mm}
        \includegraphics[width=0.5\textwidth]{Multi_carrier_Equivalent_2.eps}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{CP_1.png}
    \end{figure}
    \begin{itemize}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{CP_2.png}
    \end{figure}
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.4\textwidth]{GI.jpg}
    \end{figure}
    \begin{itemize}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{GI_cause_ISI_modify.png}
    \end{figure}
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.55\textwidth]{circular.jpg}
    \end{figure}
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.68\textwidth]{CP_7.png}
    \end{figure}   
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.75\textwidth]{cp12.png}
    \end{figure}
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.4\textwidth, trim=0cm 1cm 0cm 0.4cm, clip]{ifft_21.jpg}
    \end{figure}   
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
  \item the graph with different sampling point
    \end{itemize}
    ...
    \begin{figure}
        ...
        \begin{tabular}{cc}
            ...
            \includegraphics[width=0.45\textwidth]{copy.eps} 
        \end{tabular}
    \end{figure}
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Appendix: Carrier Frequency Offset (CFO) Results in Inter-Carrier Interference (ICI) (1/7)}
    \begin{itemize}
...
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Appendix: Carrier Frequency Offset (CFO) Results in Inter-Carrier Interference (ICI) (2/7)}
    \begin{itemize}
      ...
      \end{itemize}
      \item If iCFO exists, carriers are still orthogonal, but the signal is wrong.
      \item If fCFO exists, carriers are not orthogonal, and ICI occurs.
    \end{itemize}
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Appendix: Carrier Frequency Offset (CFO) Results in Inter-Carrier Interference (ICI) (3/7)}
    \begin{figure}
        \includegraphics[width=0.5\textwidth]{cfo_integer.eps}
    \end{figure}
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Appendix: Carrier Frequency Offset (CFO) Results in Inter-Carrier Interference (ICI) (4/7)}
    \begin{figure}
        \includegraphics[width=0.5\textwidth]{cfo_fractional.eps}
    \end{figure}
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Appendix: Carrier Frequency Offset (CFO) Results in Inter-Carrier Interference (ICI) (5/7)}
    \begin{itemize}
        \item $\psi_k(t) = e^{j 2\pi (f_0 + k\Delta f) t} \leftrightarrow \delta(f - f_0 - k\Delta f)$
        
        \item $\text{Tx: } X_k \delta(f - f_k), \quad f_k = f_0 + k\Delta f$
        
        \item $\text{Rx: }$
        \begin{align*}
            X_k \delta(f - f_k')
            &= X_k \delta(f - f_k - f_{\text{offset}}) \\
            &= X_k \delta(f - f_0 - k\Delta f - \epsilon \Delta f)
        \end{align*}
        
        \item $\text{Number of sampling points} = N, \quad T_s = \frac{1}{N\Delta f}, \quad f_k' = f_0 + k\Delta f + f_{\text{offset}}$
        
        \item The exponential term of the received carrier signal's IDFT:
        \begin{align*}
            e^{j 2\pi f t} &= e^{j 2\pi (f_0 + k\Delta f + f_{\text{offset}}) \cdot (n \cdot T_s)} \\
            &= e^{j 2\pi (f_0 + k\Delta f + \epsilon \Delta f) \cdot \left(n \cdot \frac{1}{N\Delta f}\right)} \\
            &= e^{j 2\pi n (k + \epsilon) / N} \cdot e^{j 2\pi \left(\frac{f_0}{\Delta f}\right) n / N}
        \end{align*}
    \end{itemize}
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Appendix: Carrier Frequency Offset (CFO) Results in Inter-Carrier Interference (ICI) (6/7)}
    \begin{itemize}
        \item $f_0$ is demodulated to DC by LO (Local Oscillator) and low-pass filter.
        \item The offset in the time domain and in the frequency domain:
          \begin{equation*}
            \delta(f - \epsilon)\ \longrightarrow \ \exp(j 2\pi n \epsilon / N)
          \end{equation*}
        \item IDFT of $X[k]$ with CFO:
        \begin{equation*}
            \text{IDFT}\{X[k]\} = \sum_{k=0}^{N-1} X_l[k] e^{j 2\pi n (k + \epsilon) / N}
        \end{equation*}
        \item Assume no other phase noise, the received signal can be expressed as:\\
      \begin{equation*}
        y_{l}[n] = \underbrace{\frac{1}{N} \sum_{k=0}^{N-1} H[k]X_{l}[k] e^{j 2\pi n (k+\epsilon)/N}}_{\text{IDFT signal + CFO, l means the l-th symbol}} + \underbrace{z_{l}[n]}_{\text{AWGN}}
      \end{equation*}
    \end{itemize}
\end{frame}
%-----------------------------------------------------------------------------%
%-----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Appendix: Carrier Frequency Offset (CFO) Results in Inter-Carrier Interference (ICI) (7/7)}
    \begin{figure}
      \centering
      \includegraphics[width=1\textwidth]{CFO_1.png}
    \end{figure}
    \begin{itemize}
      \item DMB: Digital Multimedia Broadcasting
      \item Doppler shift's calculation: $f_d = \frac{v}{c} f_c$, where $v$ is the relative velocity, $c$ is the speed of light, and $f_c$ is the carrier frequency.
    \end{itemize}
\end{frame}
%-----------------------------------------------------------------------------%
\begin{frame}
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Appendix: Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (1/9)}

\begin{itemize}
  \setlength{\itemsep}{1pt} % 縮減列表項目之間的間距
  \item \textbf{Proof:}
  ...
  \displaystyle
  \sum_{m\in\mathcal{M}}
  X_{m,\mathrm{prev}}e^{j2\pi f_mt},
  &0.4\leq t<0.5,\\[6pt]
  \displaystyle
  \sum_{m\in\mathcal{M}}
  X_{m,\mathrm{curr}}e^{j2\pi f_m(t-0.5)},
  &0.5\leq t<0.9.
  \end{cases}
  \]
  \vspace{-8pt}
  \item The active subcarrier set is $\mathcal{M}=\{1,2\}$.
  \item $X_{m,\mathrm{prev}}$ and $X_{m,\mathrm{curr}}$ denote the previous and current symbols on subcarrier $m$.
\end{itemize}

\vspace{-5pt} % 向上拉近 columns 與上方列表的距離

\begin{columns}[t]
\column{0.48\textwidth}
\begin{block}{Index definitions}
\vspace{-6pt}
\[
\begin{aligned}
m &: \text{transmitted subcarrier},\\
k &: \text{received FFT bin}.
\end{aligned}
\]
\vspace{-8pt}
\end{block}
...
T_s &= \frac{0.5}{N}\ \mathrm{s},\quad f_1 = 2\ \mathrm{Hz},\quad f_2 = 4\ \mathrm{Hz}.
\end{aligned}
\]
\vspace{-8pt}
\end{block}
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Appendix: Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (2/9)}
\begin{itemize}
  \item The sampling time is
  \[\scriptsize
  t_n=0.4+nT_s.
  \]
  \item The sampled signal is
  \vspace{-6pt}
  \[\scriptsize
  x[n]=
  \begin{cases}
  ...
  \sum_{m\in\mathcal{M}}
  X_{m,\mathrm{prev}}
  e^{j2\pi f_m(0.4+nT_s)},
  &0\leq n<0.2N,\\[8pt]
  \displaystyle
  \sum_{m\in\mathcal{M}}
  X_{m,\mathrm{curr}}
  e^{j2\pi f_m(-0.1+nT_s)},
  &0.2N\leq n<N.
  \end{cases}
  \]
\end{itemize}
...
\vspace{-6pt}
\begin{itemize}
  \item The FFT window contains two OFDM symbols,
  \vspace{-2pt}
  \[\scriptsize
  Y[k]
  =
  \frac{1}{N}
  \sum_{n=0}^{0.2N-1}
  x_{\mathrm{prev}}[n]e^{-j2\pi kn/N}
  +
  \frac{1}{N}
  \sum_{n=0.2N}^{N-1}
  x_{\mathrm{curr}}[n]e^{-j2\pi kn/N}.
  \]
\end{itemize}
\end{frame}
%-----------------------------------------------------------------------------%
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Appendix: Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (3/9)}
\begin{itemize}
  \item Assume the orthogonal subcarrier spacing satisfies
  \[
  f_mT_s=\frac{m}{N}.
  \]
  \item Define $\alpha_{m\rightarrow k}$ as the contribution from the previous OFDM symbol to FFT bin $k$:
\end{itemize}
\vspace{-4pt}
\[
\alpha_{m\rightarrow k}
\triangleq
\frac{1}{N}
\sum_{n=0}^{0.2N-1}
e^{j2\pi f_m(0.4+nT_s)}
...
\vspace{2pt}
\begin{itemize}
  \item Using $f_mT_s=m/N$,
  \[
  \alpha_{m\rightarrow k}
  =
  \frac{e^{j2\pi f_m(0.4)}}{N}
  \sum_{n=0}^{0.2N-1}
  e^{j2\pi(m-k)n/N}.
  \]
\end{itemize}
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Appendix: Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (4/9)}
\begin{itemize}
  \item Define $\beta_{m\rightarrow k}$ as the contribution from the current OFDM symbol to FFT bin $k$:
\end{itemize}
\vspace{-4pt}
\[
\beta_{m\rightarrow k}
\triangleq
\frac{1}{N}
\sum_{n=0.2N}^{N-1}
e^{j2\pi f_m(-0.1+nT_s)}
...
\end{itemize}
\vspace{-2pt}
\begin{block}{Frequency-domain representation}
\[
Y[k]
=
\sum_{m\in\mathcal{M}}
X_{m,\mathrm{prev}}\alpha_{m\rightarrow k}
+
\sum_{m\in\mathcal{M}}
X_{m,\mathrm{curr}}\beta_{m\rightarrow k}
\]
\end{block}
\end{frame}
%-----------------------------------------------------------------------------%
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Appendix: Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (5/9)}
\begin{itemize}
  \item \textbf{Case 1: $m=k$}
  \item For the previous OFDM symbol,
  \[
  \alpha_{k\rightarrow k}
  =
  \frac{e^{j2\pi f_k(0.4)}}{N}
  \sum_{n=0}^{0.2N-1}1
  =
  \boxed{
  0.2e^{j0.8\pi f_k}
  ...
  \qquad \text{(ISI)}.
  \]
  \item For the current OFDM symbol,
  \[
  \beta_{k\rightarrow k}
  =
  \frac{e^{-j2\pi f_k(0.1)}}{N}
  \sum_{n=0.2N}^{N-1}1
  =
  \boxed{
  0.8e^{-j0.2\pi f_k}
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Appendix: Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (6/9)}
\begin{itemize}
  \item \textbf{Case 2: $m\neq k$}
  \item For the previous OFDM symbol,
  \[
  ...
  e^{j2\pi(m-k)n/N}.
  \]
  \item Since $r_{m,k}\neq 1$, the geometric series gives
  \[
  \boxed{
  \alpha_{m\rightarrow k}
  =
  \frac{e^{j2\pi f_m(0.4)}}{N}
  \frac{1-e^{j2\pi(m-k)(0.2N)/N}}
        {1-e^{j2\pi(m-k)(N)/N}}
  }
  \]
  \item In general, $\alpha_{m\rightarrow k}\neq 0$.
\end{itemize}
\end{frame}
%-----------------------------------------------------------------------------%
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Appendix: Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (7/9)}
\begin{itemize}
  \item For the current OFDM symbol and $m\neq k$,
  \[
  \beta_{m\rightarrow k}
  =
  \frac{e^{-j2\pi f_m(0.1)}}{N}
  ...
  e^{j2\pi(m-k)n/N}.
  \]
  \item Applying the geometric-series formula,
  \[
  \boxed{
  \beta_{m\rightarrow k}
  =
  ...
  \frac{
  e^{j2\pi(m-k)(0.2N)/N}
  \left(1-e^{j2\pi(m-k)(0.8N)/N}\right)
  }
  {1-e^{j2\pi(m-k)(N)/N}}
  }
  \]
  \item In general, $\beta_{m\rightarrow k}\neq 0, \qquad m\neq k$.
\end{itemize}
\end{frame}
%-----------------------------------------------------------------------------%
...
%-----------------------------------------------------------------------------%
\begin{frame}
\frametitle{Appendix: Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (8/9)}
\begin{itemize}
  \item For two active subcarriers, $\mathcal{M}=\{1,2\}$,
\end{itemize}
\[
\begin{aligned}
Y[1]={}&
\underbrace{\beta_{1\rightarrow1}X_{1,\mathrm{curr}}}
_{\text{desired signal}}
+
\underbrace{\beta_{2\rightarrow1}X_{2,\mathrm{curr}}}
_{\text{ICI}}
+
\underbrace{\alpha_{1\rightarrow1}X_{1,\mathrm{prev}}
+\alpha_{2\rightarrow1}X_{2,\mathrm{prev}}}
_{\text{previous-symbol interference}},
\\[8pt]
Y[2]={}&
\underbrace{\beta_{2\rightarrow2}X_{2,\mathrm{curr}}}
_{\text{desired signal}}
+
\underbrace{\beta_{1\rightarrow2}X_{1,\mathrm{curr}}}
_{\text{ICI}}
+
\underbrace{\alpha_{2\rightarrow2}X_{2,\mathrm{prev}}
+\alpha_{1\rightarrow2}X_{1,\mathrm{prev}}}
_{\text{previous-symbol interference}}.
\end{aligned}
\]
\end{frame}
...
\frametitle{Appendix: Timing Synchronization Error Results in Inter-Carrier Interference (ICI) (9/9)}

\vspace{-4pt}

\begin{itemize}

    \item $Y[k]=X_{k,\mathrm{curr}}$
  \item When $m=k$,
  ...
  \item Because of subcarrier orthogonality,

  \[
  \boxed{
  \beta_{m\rightarrow k}=0,
  \qquad m\neq k.
  }
  \]
