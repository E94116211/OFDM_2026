...
%----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multipath propagation (45/8) --- Proof}
    \small
    \begin{align*}
        &=
        \left(
...
\begin{frame}
    ...
    \begin{align*}
        ...
        &=
        \Big[
        a_0a_1e^{-j2\pi f(\tau_0-\tau_1)}
        +
        a_1a_0e^{-j2\pi f(\tau_1-\tau_0)}
        \Big]
        \\[1mm]
        &\quad+
        \Big[
        a_0a_2e^{-j2\pi f(\tau_0-\tau_2)}
        +
        a_2a_0e^{-j2\pi f(\tau_2-\tau_0)}
        \Big]
        \\[1mm]
        &\quad+\cdots
        \\[1mm]
        ...
        \Big[
        a_{N-2}a_{N-1}
        e^{-j2\pi f(\tau_{N-2}-\tau_{N-1})}
        \\
        &\qquad\qquad+
        a_{N-1}a_{N-2}
        e^{-j2\pi f(\tau_{N-1}-\tau_{N-2})}
        \Big].
    \end{align*}
...
%----------------------------------------------------------------------------%
\begin{frame}
    \frametitle{Multipath propagation(666/8) --- Proof}
